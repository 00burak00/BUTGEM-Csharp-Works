<%@ Page Title="" Language="C#" MasterPageFile="~/Ziyaretci.Master" AutoEventWireup="true" CodeBehind="uye_duzenle.aspx.cs" Inherits="Veritabani_uygulamasi.uye_duzenle" %>
    ...
    <div>
             <table class="auto-style1">
                ...
                <tr>
                   ...
                   <tr>
                    <td colspan="3"><center>
                        <asp:Button ID="Button1" runat="server" Text="Güncelle" OnClick="Button1_Click" ValidationGroup="kayit" CssClass ="form-control btn-success" Width="205px" />
                       </td></center>
                </tr>
                   <tr>
                    <td colspan="3">
